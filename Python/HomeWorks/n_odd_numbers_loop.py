...
nearest_odd_number = starting_number
if starting_number % 2 != 1:
    nearest_odd_number = starting_number + 1
"""
# Priting the num_iterations number of odd numbers - Using for loop.
...
# Priting the num_iterations number of odd numbers - Using while loop
i = 0
